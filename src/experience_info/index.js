export const experience_info = [
  ...
  },
  {
    ...
    time: "Spring 2024",
    address: "Atlanta GA",
    work: "Coordinated with Machine Learning faculty professor Mahdi Roozbahani to create a multi-modal model that can take video input and generate a Chat-GPT style summary.",
  },
  {
    position: "PopSign",
    companyLink: "https://www.popsign.org/",
    ...
    time: "Spring 2024",
    address: "Atlanta GA",
    work: "Worked with Thad Starner (the creator of the Google glasses) to create a mobile app that teaches parents of deaf children sign language. Coordinated with team to implement Hidden Markov Model (HMM) used for finger spelling recognition in Android app using Kotlin.",
  },
  {
  ...
  {
    position:
      "Georgia Tech Research - Vertically Integrated Project – Experimental Flights",
    companyLink: "https://www.vip.gatech.edu/teams/vvm",
    company: "Georgia Institute of Technology",
    time: "Fall 2022 - Fall 2023",
    address: "Atlanta GA",
    work: "In this research group, I led a team of 15+ students in creating a full stack SAAS application that managed real-time drone flight information in the backend through a custom Admin dashboard for an inventory management system. With a budget of 2 thousand dollars, I investigated and found a drone solution that fit our needs that was only $150",
  },
