...
export const SvelteIcon = ({ className, ...rest }) => (
  <svg viewBox="0 0 128 128" {...rest} className={`w-full h-auto ${className}`}>
    <path
...
export const FastAPI = ({ className, ...rest }) => (
  <svg viewBox="0 0 128 128" {...rest} className={`w-full h-auto ${className}`}>
    <path
...
export const AzureIcon = ({ className, ...rest }) => (
  <svg viewBox="0 0 128 128" {...rest} className={`w-full h-auto ${className}`}>
    <defs>
      <linearGradient
        id="azure-original-a"
...
export const GCPIcon = ({ className, ...rest }) => (
  <svg viewBox="0 0 128 128" {...rest} className={`w-full h-auto ${className}`}>
    <path
      fill="#ea4535"
...
export const TensorFlowIcon = ({ className, ...rest }) => (
  <svg viewBox="0 0 128 128" {...rest} className={`w-full h-auto ${className}`}>
    <path
